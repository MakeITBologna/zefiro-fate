		...
		<html>
			<head>
				<meta http-equiv="X-UA-Compatible" content="IE=edge"/>
				 <meta charset="UTF-8" />
				<style type="text/css">
					* { overflow: visibile; overflow-wrap: break-word; word-wrap: break-word; }
					#fattura-container { width: 100%; position: relative; }

					#fattura-elettronica { font-family: sans-serif;  }
					@media not print {
					#fattura-elettronica {
					margin-left: auto; margin-right: auto; max-width: 1280px; min-width: 930px; padding: 0;
					}
					}
					...
					#fattura-elettronica h2 { padding: 20px 0 0 0; margin: 0; font-size: 20px; } <!-- XXX (Giulio) perché h2 ha il font-size più piccolo di h1 ?!? -->
					...
					#fattura-elettronica table { margin: 0 !important; padding: 15px 0 0 40px !important; }
					#fattura-elettronica ul li {}
					#fattura-elettronica ul li ul { display: block !important; }
					#fattura-elettronica ul li ul li { display: block !important; }
					#fattura-elettronica ul li span { font-weight: bold; }
					#fattura-elettronica table tr td span { font-weight: bold; }
...
-->
					...
					#fattura-elettronica
					div .page:nth-child(-n+1){ <!-- vai a pagina nuova solo se c'è un altro elemento dopo div . page -->
					...
					@media print {
					<!-- ignored by iText (try adding e.g. color:red ) -->
						tr    { page-break-inside:avoid; break-inside:avoid-page; page-break-after:auto }
						div .break    { page-break-inside:avoid; break-inside:avoid-page; page-break-after:auto;  }			
						ul .break    { page-break-inside:avoid; break-inside:avoid-page; page-break-after:auto;  } <!-- nessun effetto? -->
						li { page-break-inside:avoid; break-inside:avoid-page; page-break-after:auto; }
						table . break { page-break-inside:avoid; break-inside:avoid-page; page-break-after:auto; }
						tbody { page-break-inside:avoid; break-inside:avoid-page; page-break-after:auto; } <!-- cerco di fare in modo che "condizioni pagamento" e "dettaglio pagamento" stiano assieme -->
						h3 + div, h3 + ul, h3 + table, h4 + div, h4 +ul, h4 + table { page-break-before: avoid; break-before: avoid-page; }
					}
					@media page {
						tr    { page-break-inside:avoid; break-inside:avoid-page; page-break-after:auto }
						div    { page-break-inside:avoid; break-inside:avoid-page; page-break-after:auto; }
					}
					@page {
    					size: a4 portrait;
					}  <!-- otherwise fs adds blank page (nope, can happen anyway if the page is packed full)-->
					tr, td { width: 95%; overflow: visible; display: inline-block; } <!-- senza display: inline-block contenuti non stanno inline -->
			...
			<body>
				<div id="fattura-container">
					...
					<xsl:if test="a:FatturaElettronica">
							...
							<xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader">
								<div class="page">
									...
									<xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore">
										<div id="cedente"><!-- rimossa classe break per evitare page-break prima di questa sezione -->
													...
													<xsl:for-each select="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore/DatiAnagrafici">
														...
														<xsl:if test="DataIscrizioneAlbo">
															<li>
																...
																<span>
																<span><xsl:call-template name="FormatDate">
									...
									<xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/RappresentanteFiscale">
										<div id="rappresentante-fiscale" class="break">
									...
									<xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/TerzoIntermediarioOSoggettoEmittente">
										<div id="terzointermediario" class="break">
							...
							<xsl:for-each select="a:FatturaElettronica/FatturaElettronicaBody">
								...
								<div class="page">
									...
									<xsl:if test="DatiGenerali">
										...
										<div id="dati-generali" class="break">
																		...
																		<xsl:for-each select="AltriDatiGestionali">
																			...
																			<xsl:if test="RiferimentoData">
																				<li>
																					...
																					<span><span><xsl:call-template name="FormatDate">
									...
									<xsl:if test="DatiPagamento">
										<div id="dati-pagamento-condizioni" class="break">
						...
						</div><!-- fine div id="fattura-elettronica" -->
					</xsl:if>
				</div><!--  fine div id="fattura-container" -->
			</body>
		</html>
	</xsl:template>
</xsl:stylesheet>