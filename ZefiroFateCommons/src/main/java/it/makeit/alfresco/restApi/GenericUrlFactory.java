...
public final class GenericUrlFactory {
	...
	protected final Logger mLog = LoggerFactory.getLogger(GenericUrlFactory.class);
	...
	public GenericUrl build(Map<String, Object> parameters) {
		...
		for (Entry<String, Object> param : parameters.entrySet()) {
			...
			if (!paramNames.contains(key)) {
				mLog.warn(String.format("The parameter '%s' is not documented,  it may not be accepted", key));
			}
