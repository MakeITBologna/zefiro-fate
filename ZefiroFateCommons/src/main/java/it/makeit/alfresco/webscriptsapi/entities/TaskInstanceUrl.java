...
import it.makeit.alfresco.webscriptsapi.AlfrescoTaskInstanceQueryParamsEnum;

public class TaskInstanceUrl extends GenericUrl implements AlfrescoBaseUrl {

	private static final String PATH = "/task-instances";
	private String pathParam;
	private Set<String> params;

	public TaskInstanceUrl(URL pHostUrl) {
		super(pHostUrl);
		populateParams();
	...
	private void populateParams() {
		...
		addParam(AlfrescoRESTQueryParamsEnum.SKIP_COUNT, AlfrescoRESTQueryParamsEnum.MAX_ITEMS,
				AlfrescoRESTQueryParamsEnum.EXCLUDE);

		addParam(AlfrescoTaskInstanceQueryParamsEnum.values());
	}
