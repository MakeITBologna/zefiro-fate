...
/**
 * <p>Classe Java per RicevutaScarto_Type complex type.
 * 
 ...
 *         &lt;element name="ListaErrori" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fattura/messaggi/v1.0}ListaErrori_Type"/>
...
@XmlType(name = "RicevutaScarto_Type", namespace = "http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fattura/messaggi/v1.0", propOrder = {
    "identificativoSdI",
    "nomeFile",
    "hash",
    "dataOraRicezione",
...
public class RicevutaScartoType {
