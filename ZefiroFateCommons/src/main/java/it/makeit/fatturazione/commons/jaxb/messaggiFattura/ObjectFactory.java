 ...
 * generated in the it.makeit.fatturazione.commons.jaxb.messaggiFattura package. 
...
public class ObjectFactory {
    ...
    private final static QName _RicevutaScarto_QNAME = new QName("http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fattura/messaggi/v1.0", "RicevutaScarto");
    private final static QName _KeyInfo_QNAME = new QName("http://www.w3.org/2000/09/xmldsig#", "KeyInfo");
    private final static QName _SignatureValue_QNAME = new QName("http://www.w3.org/2000/09/xmldsig#", "SignatureValue");
    private final static QName _FileMetadati_QNAME = new QName("http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fattura/messaggi/v1.0", "FileMetadati");
    private final static QName _KeyValue_QNAME = new QName("http://www.w3.org/2000/09/xmldsig#", "KeyValue");
    private final static QName _RicevutaImpossibilitaRecapito_QNAME = new QName("http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fattura/messaggi/v1.0", "RicevutaImpossibilitaRecapito");
    private final static QName _Transforms_QNAME = new QName("http://www.w3.org/2000/09/xmldsig#", "Transforms");
    private final static QName _RicevutaConsegna_QNAME = new QName("http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fattura/messaggi/v1.0", "RicevutaConsegna");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.makeit.fatturazione.commons.jaxb.messaggiFattura
     * 
     */
    ...
    public JAXBElement<RicevutaScartoType> createRicevutaScarto(RicevutaScartoType value) {
        return new JAXBElement<RicevutaScartoType>(_RicevutaScarto_QNAME, RicevutaScartoType.class, null, value);
    }
    ...
    public JAXBElement<FileMetadatiType> createFileMetadati(FileMetadatiType value) {
        return new JAXBElement<FileMetadatiType>(_FileMetadati_QNAME, FileMetadatiType.class, null, value);
    }
    ...
    public JAXBElement<RicevutaImpossibilitaRecapitoType> createRicevutaImpossibilitaRecapito(RicevutaImpossibilitaRecapitoType value) {
        return new JAXBElement<RicevutaImpossibilitaRecapitoType>(_RicevutaImpossibilitaRecapito_QNAME, RicevutaImpossibilitaRecapitoType.class, null, value);
    }
